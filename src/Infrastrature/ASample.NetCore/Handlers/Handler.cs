...
namespace ASample.NetCore.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<ASampleException, Task> _onCustomError;
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (ASampleException customException)
            {
                isFailure = true;
        ...
        public IHandler OnCustomError(Func<ASampleException, Task> onCustomError, bool rethrow = false)
        {
