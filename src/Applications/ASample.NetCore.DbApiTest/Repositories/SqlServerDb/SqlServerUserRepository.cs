...
namespace ASample.NetCore.DbApiTest.Repositories
{
    public class SqlServerUserRepository : ISqlServerUserRepository
    {
        ...
        private IUnitOfWork<ASampleSqlServerDbContext> _unitOfWork;

        public SqlServerUserRepository(ISqlServerRepository<User> sqlServerRepository, IUnitOfWork<ASampleSqlServerDbContext> unitOfWork)
        {
