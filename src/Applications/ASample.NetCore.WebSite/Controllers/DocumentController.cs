...
namespace ASample.NetCore.WebSite.Controllers
{
    ...
    public class DocumentController : ControllerBase
    {
        ...
        {
            string path = @"F:\my_self\project_git2019\ASampleNetCore\src\Applications\ASample.NetCore.WebSite\test.docx";
        ...
        public ActionResult Create()
        {
            ...
            var dto = new InvoiceModel
            {
                ...
                Items = new List<InvoiceItemModel>(){
                    ...
                    {
                        Date = Convert.ToDateTime("2019-06-25"),
                        Hours = 5,
                        Price = 50,
                    },
            ...
            SaveOptions options = GetSaveOptions("DOCX");
            DocumentModel document = this.Process(dto);

            return File(GetBytes(document, options), options.ContentType, "Create." + dto.SelectedFormat.ToLowerInvariant());
        }
    }
